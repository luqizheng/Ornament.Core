...
namespace Ornament.Collecions
{
    ...
    public class PriorityQueue<T> : IEnumerable<T>
    {
        ...
        public virtual void Enqueue(T item)
        {
            ...
            _heap.Sift(Count, _comparer, -1); // move item "up" until heap principles are not met
        }
        ...
        ///// <param name="shift">
        /////     Shift allows to compensate and work with arrays where heap starts not from the element at position 1.
